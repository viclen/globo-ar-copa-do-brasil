 ...
 *
 * @property {Number|null} [duration=0] The duration in seconds that this emitter should live for. If not specified, the emitter
...
SPE.Emitter = function( options ) {
    ...
    this.duration = utils.ensureTypedArg( options.duration, types.NUMBER, 0 );
