        ...
        if (!window.mobileCheck()) {
            document.body.innerHTML = `
                <div class="not-mobile">
                    <div class="logo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="109.801" height="42.484" viewBox="0 0 109.801 42.484">
                            <g id="Grupo_258" data-name="Grupo 258" transform="translate(1770.205 838.278)">
